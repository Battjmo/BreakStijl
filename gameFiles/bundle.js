...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./gameFiles/util.js");
  ...
  let brick32 = {x: 90, y: 160, width: 30, height: 50, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick33 = {x: 100, y: 160, width: 70, height: 60, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick34 = {x: 150, y: 160, width: 50, height: 30, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick35 = {x: 180, y: 160, width: 40, height: 40, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick36 = {x: 200, y: 160, width: 80, height: 60, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick37 = {x: 260, y: 160, width: 30, height: 50, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick38 = {x: 270, y: 160, width: 60, height: 30, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick39 = {x: 310, y: 160, width: 120, height: 40, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
  let brick40 = {x: 420, y: 160, width: 50, height: 20, status: 1, color: _util__WEBPACK_IMPORTED_MODULE_0__["default"].hue()};
